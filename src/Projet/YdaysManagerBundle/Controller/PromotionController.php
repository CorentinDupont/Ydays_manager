...
class PromotionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $promotions = $em->getRepository('ProjetYdaysManagerBundle:Promotion')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('Projet\YdaysManagerBundle\Form\PromotionType', $promotion);
    ...
    {
        $deleteForm = $this->createDeleteForm($promotion);
        $editForm = $this->createForm('Projet\YdaysManagerBundle\Form\PromotionType', $promotion);
